...
public class Robot extends TimedRobot {
 ...
 private RobotContainer m_robotContainer;
  ...
  public void autonomousInit() {
    ...
    m_robotContainer.m_wristSubsystem.moveWrist(3000.0); //get value!!!!! move wrist downwards into space
    ...
    m_robotContainer.m_clawSubsystem.noPowerClaw(); //gives no power to claw
    m_robotContainer.m_wristSubsystem.moveWrist(830.0); //get value!!!!! move wrist compact 
    wait(1000);
